"""M4 parity: RedisVectorStore must behave like SqliteVectorStore."""
...
def test_redis_parity():
    pytest.importorskip("fakeredis")
    client = pytest.importorskip("fakeredis").FakeStrictRedis()
    run_parity_scenarios(RedisVectorStore(client=client))
